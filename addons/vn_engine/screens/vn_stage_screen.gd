...
func handle_back() -> bool:
	if VNGame.state() == VNGame.AppState.CHAPTER:
		open_game_menu()
		return true
	return false
...
func open_game_menu() -> void:
	var menu: Control = VNGame.open_overlay(&"game_menu")
	if menu == null:
		return
...
func _on_menu_title() -> void:
	...
	VNGame.open_overlay(&"confirm", {
		...
		"confirm_text": "Title",
		"cancel_text": "Cancel",
	}).confirmed.connect(VNGame.return_to_title)
...
func _on_menu_quit() -> void:
	...
	VNGame.open_overlay(&"confirm", {
		...
		"confirm_text": "Quit",
		"cancel_text": "Cancel",
	}).confirmed.connect(VNGame.quit_game)
